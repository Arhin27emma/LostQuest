                ...
                children: [
                  ...
                  (
                    text: "Publish", press: () async{
                      ...
                      if (dropdownValue.isEmpty || _name.text.trim().isEmpty || dropdown.isEmpty || _date.text.trim().isEmpty || _description.text.trim().isEmpty || imageUrl.isEmpty) {
...
class _EditPostState extends State<EditPost> {
  ...
  static final FirebaseAuth _auth = FirebaseAuth.instance;
  late final String id = FirebaseFirestore.instance.collection("AddPostDB").doc().id;
