...
class FoundPost extends StatefulWidget {
  ...
  static String routeName = "foundPost.dart";
...
class _FoundPostState extends State<FoundPost> {
  ...
  late final String id = _foundDataCollection.doc(_auth.currentUser!.email).collection('foundDB').doc().id;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("FOUND POST", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.red)),
        titleSpacing: 80,
      ),
      body: SafeArea(
        //child: Center(
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  const Center(child: Text("Enter Details To Report Found Items", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,),)),
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: const InputDecoration(
                          ...
                          hintText: "Enter found item name",
                  ...
                  const Padding(
                    ...
                    child: Text("Date Found", style: TextStyle(fontSize: 18),),
                  ),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 8),
                    child: Container(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: const InputDecoration(
                          ...
                          //suffixIcon: Icon(Icons.person_3_outlined),
                          hintText: "Enter found item description here",
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide.none
                          )
                        ),
                  ...
                  Center(child: DefaultButton(text: "Publish", press: () async{
                    ...
                    if (selectedImage != null) {
                      foundImageUrl = await _databaseService.uploadImage(selectedImage!);
                    }
                    
                    if (dropdownValue.isEmpty || _fname.text.trim().isEmpty || dropdown.isEmpty || _date.text.trim().isEmpty || _description.text.trim().isEmpty || foundImageUrl.isEmpty) {                        
                      ...
                      sendNotification(_fname.text.trim());
                    }
                    clear();
                  })
                  ),
