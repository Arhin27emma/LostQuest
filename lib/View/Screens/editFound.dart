...
class _EditPostState extends State<EditPost> {
  ...
  static final CollectionReference _lostDataCollection = FirebaseFirestore.instance.collection("AddPostDB");
  static final FirebaseAuth _auth = FirebaseAuth.instance;
  late final String id = _lostDataCollection.doc(_auth.currentUser!.email).collection('lostDB').doc().id;
  late final String fid = _foundDataCollection.doc(_auth.currentUser!.email).collection('foundDB').doc().id;
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Center(child: Text("Enter Details To Update Items", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,),)),
                ...
                Center(child: DefaultButton
                  ...
                  if (dropdownValue.isEmpty || _fname.text.trim().isEmpty || dropdown.isEmpty || _date.text.trim().isEmpty || _description.text.trim().isEmpty) {
